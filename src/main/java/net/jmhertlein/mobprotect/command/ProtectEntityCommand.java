 ...
 * @author joshua
 */
public class ProtectEntityCommand extends CommandLeaf {
    private final Set<Player> pendingProtectors;
    
    public ProtectEntityCommand(final Set<Player> pendingProtectors) {
        super("protect");
    ...
    public void execute(CommandSender sender, Command cmd, String[] args) throws InsufficientPermissionException, UnsupportedCommandSenderException {
        ...
        pendingProtectors.add((Player) sender);
        sender.sendMessage(ChatColor.GOLD + "Punch an entity to protect it.");
